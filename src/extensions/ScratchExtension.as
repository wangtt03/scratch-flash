...
public class ScratchExtension {
	...
	public static function StemAI():ScratchExtension {
		// Return a descriptor for the LEGO WeDo 2.0 extension.
		var result:ScratchExtension = new ScratchExtension(ExtensionManager.stemAIExt, 0);
		result.isInternal = true;
		result.javascriptURL = Scratch.app.server.getOfficialExtensionURL('stemAIExtension.js');
		result.thumbnailMD5 = 'scratchextensionstemai.png';
		result.url = 'howto/wedo2setup-intro.html';
		result.tags = ['ai'];
		return result;
	}
